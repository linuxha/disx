...
private:
    ...
    void do_go_addr(addr_t addr); // go to address
...
public: // can't be private unless dispatch tables are moved into the class
    ...
    void do_cmd_label(char *p); // handle "label" command
    void do_cmd_hex(char *p);   // handle "hex"  command
    void do_cmd_octal(char *p); // handle "octal" command
    ...
    void do_cmd_E();            // handle 'E' command
    void do_cmd_e();            // handle 'e' command
